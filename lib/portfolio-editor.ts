import type { CustomBlock, ExperienceItem, ResearchItem, SiteSettings } from "@/lib/portfolio-content";
...
export type EditTarget =
  ...
  | { scope: "custom"; index: number; field: keyof CustomBlock; label: string; scale?: ScaleField; base?: number; min?: number; max?: number };
