  ...
  return (
    <section id="about" className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-semibold mb-10 tracking-tight">Core Competencies</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 md:auto-rows-[200px]">
          {/* CFA Block - Large */}
          <div className="md:col-span-2 bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow relative overflow-hidden group">
            ...
            <div>
              ...
              <h3 className="text-4xl font-bold">CFA Level 2 Candidate</h3>
            </div>
            <p className="text-gray-500 mt-2 text-base">Đang trên hành trình chinh phục chứng chỉ danh giá nhất trong lĩnh vực đầu tư.</p>
          </div>
          ...
          <div className="bg-black text-white rounded-3xl p-6 flex flex-col justify-between shadow-sm group">
            ...
            <div>
              <h3 className="font-bold text-xl">Fintech & Data</h3>
              <p className="text-gray-400 text-base mt-1">Python, Flask, SQL, Valuation Modeling</p>
            </div>
          </div>
          ...
          <div className="md:col-span-2 bg-white rounded-3xl p-8 border border-gray-100 shadow-sm flex items-center justify-between hover:shadow-md transition-shadow">
             <div className="max-w-md">
               ...
               <h3 className="text-3xl font-bold mb-2">Market Research & Strategy</h3>
               <p className="text-gray-500 text-base">Chuyên sâu về Bất động sản KCN, Vĩ mô Việt Nam & Quỹ ETF.</p>
             </div>
